...
public class Cuenta{
    ...
    private Cliente titular = new Cliente();    // Se genera una referencia hacia cliente (conecta ambas clases)

    public static int total = 0; // 

    public Cuenta(int agencia, int numero){        // Este es un constructor, define la manera en que se inicializará una nueva instancia
        if (this.agencia < 0){
